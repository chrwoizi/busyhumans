...
import _root_.java.util.{ArrayList, Date, UUID}
...
import com.c5000.mastery.backend.{Initializer, TimeHelper, Tokenizer}
import com.c5000.mastery.database.Database
import com.c5000.mastery.database.models.{AccountM, AnnouncementM, AssignmentM, PersonM}
import com.c5000.mastery.database.queries.AssignmentQ
import com.c5000.mastery.database.search.{Search, SearchBeanTypes}
...
class MasteryS extends BaseS with IMasteryS {
    ...
    override def createActivity(assignmentIdStr: String, contentBlocks: java.util.ArrayList[ContentBlockD]): ActivityVD = {
        ...
        val result = ActivityS.createActivity(UUID.fromString(assignmentIdStr), contentBlocks.asScala, getUserAccountId, getUserPersonId, getCloak != null, userIsAdmin(), uploadTokenizer)
