...
public class Topbar extends Composite implements MasteryEvents.Listener {
    ...
    @UiField AccountMenu account;
    @UiField HTMLPanel loginDisabled;
    ...
    protected void onAttach() {
        ...
        create.setVisible(Config.ENABLE_LOGIN);
        account.setVisible(Config.ENABLE_LOGIN);
        loginDisabled.setVisible(!Config.ENABLE_LOGIN);
