 ...
 * </pre>
 */
public class WidgetCustomButton extends ButtonBase {
    /**
     ...
     */
    public WidgetCustomButton(Image upImage) {
        this();
     ...
     */
    public WidgetCustomButton(Image upImage, ClickHandler handler) {
        this(upImage);
     ...
     * @deprecated Use {@link #WidgetCustomButton(Image, ClickHandler)} instead
     */
    @Deprecated
    public WidgetCustomButton(Image upImage, ClickListener listener) {
        this(upImage);
     ...
     */
    public WidgetCustomButton(Image upImage, Image downImage) {
        this(upImage);
     ...
     */
    public WidgetCustomButton(Image upImage, Image downImage, ClickHandler handler) {
     ...
     * @deprecated Use {@link #WidgetCustomButton(Image, Image, ClickHandler)} instead
     */
    @Deprecated
    public WidgetCustomButton(Image upImage, Image downImage, ClickListener listener) {
     ...
     */
    public WidgetCustomButton(String upText) {
        this();
     ...
     * @param handler the click handler
     */
    public WidgetCustomButton(String upText, ClickHandler handler) {
        this(upText);
        addClickHandler(handler);
    }
     ...
     * @param upText   the text for the default (up) face of the button
     * @param listener the click listener
     * @deprecated Use {@link #WidgetCustomButton(String, ClickListener)} instead
     */
    @Deprecated
    public WidgetCustomButton(String upText, ClickListener listener) {
        this(upText);
        addClickListener(listener);
    }
     ...
     */
    public WidgetCustomButton(String upText, String downText) {
        this(upText);
     ...
     * @param handler  the click handler
     */
    public WidgetCustomButton(String upText, String downText, ClickHandler handler) {
     ...
     * @param downText the text for the down face of the button
     * @param listener the click listener
     * @deprecated Use {@link #WidgetCustomButton(String, String, ClickHandler)} instead
     */
    @Deprecated
    public WidgetCustomButton(String upText, String downText, ClickListener listener) {
        this(upText, downText);
        addClickListener(listener);
    }
     ...
     * Constructor for <code>CustomButton</code>.
     */
    protected WidgetCustomButton() {
        // Use FocusImpl.getFocusImplForPanel() rather than FocusWidget because only FocusImpl.getFocusImplForPanel()
    ...
    public void setBaseFaceWidget(Widget newBase) {
        if (base != newBase) {
            if (base != null) {
                DOM.removeChild(getElement(), base.getElement());
            }
            base = newBase;
            DOM.insertChild(getElement(), base.getElement(), 1);
        }
    }

    @UiChild(tagname = "downFace")
    public void setDownFaceWidget(Widget upHovering) {
        getDownFace().setWidget(upHovering);
    }

    @UiChild(tagname = "downHoveringFace")
    public void setDownHoveringFaceWidget(Widget upHovering) {
        getDownHoveringFace().setWidget(upHovering);
    }

    @UiChild(tagname = "downDisabledFace")
    public void setDownDisabledFaceWidget(Widget upHovering) {
        getDownDisabledFace().setWidget(upHovering);
    }

    @UiChild(tagname = "upFace")
    public void setUpFaceWidget(Widget upHovering) {
        getUpFace().setWidget(upHovering);
    }

    @UiChild(tagname = "upHoveringFace")
    public void setUpHoveringFaceWidget(Widget upHovering) {
        getUpHoveringFace().setWidget(upHovering);
    }

    @UiChild(tagname = "upDisabledFace")
    public void setUpDisabledFaceWidget(Widget upHovering) {
        getUpDisabledFace().setWidget(upHovering);
    }
