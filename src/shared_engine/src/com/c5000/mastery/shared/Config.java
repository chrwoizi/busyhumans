...
public class Config {
    ...
    public static final String GWT_CODE_SVR = "gwt.codesvr=192.168.178.23:9997";

    public static final String BASE_URL_DEV = "http://dev.busyhumans.com:8888/";
    public static final String BASE_URL_LIVE = "http://busyhumans.com/";
